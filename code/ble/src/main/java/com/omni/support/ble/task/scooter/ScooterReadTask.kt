 ...
 *
 */
class ScooterReadTask(private val session: ISession, listener: OnProgressListener<String>) :
    ...
    override fun start() {
        AppExecutors.WORK_THREAD.execute {
            try {
                ...
                val packInfo = session.call(CommandManager.scooterCommand.startRead()).execute()
