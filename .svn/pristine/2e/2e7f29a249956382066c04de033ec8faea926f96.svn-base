 ...
 * @author 邱永恒
 *
 * @time 2019/8/30 13:43
 *
 * @desc
 *
 */
interface ULockCommands {
    /**
     * 获取蓝牙通讯key
     */
    @CommandID(0x11)
    fun getKey(deviceKey: String): Command<ULockKeyResult>
     ...
     */
    @CommandID(0x21)
    fun unlock(@S32 uid: Int, @U32 timestamp: Long): Command<Boolean>
     ...
     */
    @CommandID(0x22)
    fun lock(): Command<ULockLockResult>

    /**
     * 获取锁状态信息
     */
    @CommandID(0x31)
    fun getLockInfo(): Command<ULockInfoResult>

    /**
     * 获取未上传数据
     */
    @CommandID(0x51)
    fun getOldData(): Command<ULockOldDataResult>
